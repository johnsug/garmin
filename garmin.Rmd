...
<br>
<h5>This digital portfolio was created by John Sugden using the 'flexdashboard' package in R. For more about John, please see my <a href=http://johnsug.github.io><i class="fa fa-rss-square"></i> blog</a> and <a href=https://www.linkedin.com/in/johnsugden><i class="fa fa-linkedin-square"></i> LinkedIn</a> profile.</h5>
...
Lastly, the percent change between the first and last activities in the selected time horizon is provided as the periodic change. 

<br><a href=#changepoint-analysis><i class="fa fa-arrow-left"></i></a> <a href=#pace-benchmarking><i class="fa fa-arrow-right"></i></a></h4>
...
<h4>In this plot, historical activities (blue dots) are compared to benchmarks of both historical best paces (green line) and average paces (gold line) from the selected time horizon. 

<br><a href=#trend-analysis><i class="fa fa-arrow-left"></i></a> <a href=#calendar-heatmap><i class="fa fa-arrow-right"></i></a></h4>
...
<h4>This widget, inspired by Github's productivity heatmap, can be used to quickly illustrates day-of-the-week and week-to-week activity trends. 

<br><a href=#pace-benchmarking><i class="fa fa-arrow-left"></i></a> <a href=#changepoint-analysis><i class="fa fa-arrow-right"></i></a></h4>
...
In this example, I'm using changepoint analysis to determine shifts in the intensity of recorded runs, in terms of instanteous speed. (While runners are usually more concerned about average pace, looking at their speed in terms of miles per hour makes more sense in this example.) Each segment is displayed visually, and the associated table details summary statistics from each significant shift in intensity. 

<br><a href=#calendar-heatmap><i class="fa fa-arrow-left"></i></a> <a href=#trend-analysis><i class="fa fa-arrow-right"></i></a></h4>
