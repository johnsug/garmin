...
<h4>This widget, inspired by Github's productivity heatmap, can be used to quickly illustrates day-of-the-week and week-to-week activity trends.</h4>
...
<h4>This widget provides simple trend analysis, highlighting period-over-period changes in the specified metrics. The linear shift in trend (dark blue line) is fit with linear regression methods, while the light blue shading shows the 95% confidence interval for the linear trend line.</h4>
