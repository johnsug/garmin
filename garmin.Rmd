...
shinyApp(
  ui = 
    fillPage(
      ...
      ## control widgets
      fluidRow(
        column(6, radioButtons("frontier", label="Time horizon for frontier:", 
                               choices=list("4 weeks"=1, "6 months"=6, "12 months"=12, "All Time"=999), 
                               inline=T, selected=12)),
        ### make dynamic !!!!
        column(6, radioButtons("dea_points", label="Time horizon for data points:", 
                               choices=list("4 weeks"=1, "6 months"=6, "12 months"=12), 
                               inline=T, selected=12))
      ),
...
<h4>(Real simple linear trend analysis right now, will work on something a bit more specific before showing to Garmin...)</h4><br><br>
...
shinyApp(
  ui = fillPage(
    radioButtons("trend_radios", label="Historic period:", choices=list("4 weeks"=1, "6 months"=6, "12 months"=12), inline=T, selected=12),
  ...
  server = function(input, output) {
    ...
    plot_dat <- reactive({
      pd <- a
      if(input$trend_radios==1) {pd <- pd[Date > dates_4_weeks]}
