...
shinyApp(
  ...
  server = function(input, output) {
    ...
    output$mc_plot <- renderPlotly({
      ...
      ## add gold star for most recent activity?
      add_trace(x=recent$Distance, y=recent$Mins, name="Most Recent", mode="markers", opacity=.8, 
                marker=list(symbol="x", size=20, color="red"))
