...
In this plot, historical activities (blue dots) are compared to benchmarks of both historical best paces (green line) and average paces (gold line) from the selected time horizon.</h4>
...
This calendar heatmap displays both which days of the week/year I've run and how far I've run each day. (Yellow blocks indicate low milage days, green blocks indicate average mileage days, and dark-green blocks indicate high milage days). This heatmap is especially useful to hone in on day-of-the-week and week-to-week activity trends.</h4>
